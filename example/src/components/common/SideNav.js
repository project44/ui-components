      ...
      >
        ...
        >
          <Menu.Item key={`${routes.components}${routes.buttons}`}>
            <Link to={`${routes.components}${routes.buttons}`}>Buttons</Link>
          </Menu.Item>
          <Menu.Item key={`${routes.components}${routes.datepicker}`}>
            <Link to={`${routes.components}${routes.datepicker}`}>Date Picker</Link>
          </Menu.Item>
          <Menu.Item key={`${routes.components}${routes.chips}`}>
            <Link to={`${routes.components}${routes.chips}`}>Chips</Link>
          </Menu.Item>
          <Menu.Item key={`${routes.components}${routes.input}`}>
            <Link to={`${routes.components}${routes.input}`}>Input</Link>
          </Menu.Item>
          <Menu.Item key={`${routes.components}${routes.multiInput}`}>
            <Link to={`${routes.components}${routes.multiInput}`}>Multi Input</Link>
          </Menu.Item>
          <Menu.Item key={`${routes.components}${routes.checkbox}`}>
            <Link to={`${routes.components}${routes.checkbox}`}>Checkbox</Link>
          </Menu.Item>
          <Menu.Item key={`${routes.components}${routes.select}`}>
            <Link to={`${routes.components}${routes.select}`}>Select</Link>
          </Menu.Item>
          <Menu.Item key={`${routes.components}${routes.radio}`}>
            <Link to={`${routes.components}${routes.radio}`}>Radio</Link>
          </Menu.Item>
          <Menu.Item key={`${routes.components}${routes.shipmentModeIcon}`}>
            <Link to={`${routes.components}${routes.shipmentModeIcon}`}>Shipment Mode Icon</Link>
          </Menu.Item>
          <Menu.Item key={`${routes.components}${routes.subHeader}`}>
            <Link to={`${routes.components}${routes.subHeader}`}>Sub-Header</Link>
          </Menu.Item>
          <Menu.Item key={`${routes.components}${routes.stickyNav}`}>
            <Link to={`${routes.components}${routes.stickyNav}`}>Sticky Nav</Link>
          </Menu.Item>
          <Menu.Item key={`${routes.components}${routes.colorPicker}`}>
            <Link to={`${routes.components}${routes.colorPicker}`}>Color Picker</Link>
          </Menu.Item>
          <Menu.Item key={`${routes.components}${routes.message}`}>
            <Link to={`${routes.components}${routes.message}`}>Message</Link>
          </Menu.Item>
