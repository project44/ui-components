    ...
    <div className="p44-ui__page">
      ...
      <div className="page-content">
        ...
        <p className="mb-8">
          ...
          and the theme will be overwritten. You can add any classNames necessary to the component, and
          have full access to the <a href="https://ant.design/components/button/" target="_blank" rel="noopener noreferrer">Ant Button API</a>.
        </p>
        <section className="page-section">
          ...
          <p>
            The Brand button generally should only be used once per component screen at any one time. It is used when there is an action that
...
<Button type="primary" size="xsm">Primary brand XS</Button>`}
        ...
        <section className="page-section">
          ...
          <p>
            The Ink Button can be used multiple times per screen, and can be
            thought of as the default button option. It is used when there are
            primary actions associated with the current application screen or
            content section. An example is when you have a “Apply” button in the
            filter panel. This button is associated with the section in which
            it’s contained.
          </p>
          <div className="example__render flex items-end">
...
<Button size="xsm">Primary ink XS</Button>`}
        ...
        <section className="page-section">
          ...
          <p>The primary ink button is to indicate section or page level actions.</p>
          <p>
            The Ink + Icon Button can be used multiple times per screen. It is
            used when there are actionable tasks associated with the current
            application screen or content section. An example would be item
            level actions like “Share Link” or “Manage Notifications”. This
            button is associated with the section in which it’s contained.
          </p>
          <div className="example__render flex items-end">
...
<Button type="secondary" size="xsm">Tertiary Gray-40 XS</Button>`}
        ...
        <section className="page-section">
          ...
          <div className="example__render">
            <Button type="destructive" size="lg" className="mb-4">Destructive Outline LG</Button>
            <Button type="destructive" className="mb-4">Destructive Outline MD</Button>
            <Button type="destructive" size="sm" className="mb-4">Destructive Outline SM</Button>
            <Button type="destructive" size="xsm" className="mb-4">Destructive Outline XS</Button>
          </div>
          <div className="component__usage mt-8">
            <SyntaxHighlighter language='jsx' style={xonokai}>
              {`import { Button } from 'ui-components';\n
...
<Button type="destructive" size="xsm">Destructive Outline XS</Button>`}
        ...
        <section className="page-section">
          ...
          <div className="example__render flex flex items-end">
            <Button type="destructive-text" size="lg">Destructive Tex-Icon LG<i className="material-icons right">delete</i></Button>
            <Button type="destructive-text">Destructive Tex-Icon MD<i className="material-icons right">delete</i></Button>
            <Button type="destructive-text" size="sm">Destructive Tex-Icon SM<i className="material-icons right">delete</i></Button>
            <Button type="destructive-text" size="xsm">Destructive Tex-Icon XS<i className="material-icons right">delete</i></Button>
          </div>
          <div className="component__usage mt-8">
            <SyntaxHighlighter language='jsx' style={xonokai}>
              {`import { Button } from 'ui-components';\n
